...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    const vars = {
        ...
        FISH_AUDIO_API_KEY: process.env.FISH_AUDIO_API_KEY ? 'CONFIGURADA (Longitud: ' + process.env.FISH_AUDIO_API_KEY.length + ')' : 'NO CONFIGURADA',
        FISH_AUDIO_REFERENCE_ID: process.env.FISH_AUDIO_REFERENCE_ID ? 'CONFIGURADA' : 'NO CONFIGURADA',
