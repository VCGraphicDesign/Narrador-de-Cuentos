...
const MINIMAX_CONFIG = {
    ...
    API_KEY: (import.meta as any).env?.VITE_MINIMAX_API_KEY || (window as any).process?.env?.VITE_MINIMAX_API_KEY,
    GROUP_ID: (import.meta as any).env?.VITE_MINIMAX_GROUP_ID || (window as any).process?.env?.VITE_MINIMAX_GROUP_ID,
